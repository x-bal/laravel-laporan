...
<body>
    ...
    <div class="content" style="margin: auto; width: 70%; display: block; justify-content: center; border-bottom: 1px solid black;">
        <h4 style="text-transform: uppercase; text-align: center;">TOTAL PENGELUARAN BIAYA KARYAWAN PADA BULAN {{ $bln }}</h4>
        <div class=" gaji" style="margin-top: 20px;">
            ...
            <table style="font-size: 12px;" border="1" cellspacing="0">
                ...
                <tr>
                    ...
                    <td width="100px">{{ $akm->karyawan->id_karyawan }}</td>
            ...
            <table style="font-size: 12px; margin-top: 20px; margin-bottom: 20px;" cellspacing="0">
                <tr>
                    ...
                    <td width="350px"> : </td>
                    <td width="200px" style="text-align: center;">@currency($gaji)</td>
                </tr>
            </table>
        </div>
        ...
        <div class="tambahan" style="margin-top: 20px;">
            ...
            <table style="font-size: 12px; margin-top: 20px; margin-bottom: 20px;" cellspacing="0">
                <tr>
                    ...
                    <td width="250px"> : </td>
                    <td width="150px" style="text-align: center;">@currency($totalPend)</td>
                </tr>
            </table>
        </div>
        ...
        <div class="pengurangan" style="margin-top: 20px; margin-bottom: 10px;">
            ...
            <table style="font-size: 12px;" border="1" cellspacing="0">
                ...
                <tr>
                    <td width="20px" style="text-align: center;">{{ $loop->iteration }}</td>
                    <td width="100px">{{ $peng->user->karyawan->id_karyawan }}</td>
                    ...
                    <td width="100px" style="text-align: center;">@currency($peng->jenis->nominal)</td>
                </tr>
                @php
            ...
            <table style="font-size: 12px; margin-top: 20px; margin-bottom: 20px;" cellspacing="0">
                <tr>
                    ...
                    <td width="280px"> : </td>
                    <td width="150px" style="text-align: center;">@currency($totalPeng)</td>
                </tr>
                @php
                ...
                <tr>
                    ...
                    <td width="280px"> : </td>
                    <td width="150px" style="text-align: center;">@currency($totalBpjs)</td>
                </tr>
            </table>
        </div>
    </div>
    ...
    <div class="total" style="margin: auto; width: 70%; display: block; justify-content: center; border-bottom: 1px solid black;">
        <table style="font-size: 12px; margin-top: 20px; margin-bottom: 20px;" cellspacing="0">
            <tr>
                ...
                <td width="300px"> : </td>
                <td width="150px" style="text-align: center;">@currency(($gaji + $totalPend) - ($totalPeng + $totalBpjs))</td>
            </tr>
        </table>
    </div>
