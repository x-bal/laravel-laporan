...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form action="{{url('report/error/store')}}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="">Tanggal Map Error</label>
...
<div class="card shadow mb-4">
<div class="card-header py-3">
  <h6 class="m-0 font-weight-bold text-dark">Laporan Map Error</h6>
</div>
<div class="card-body">
  <div class="table-responsive">
    ...
    <form action="{{url('report/error/export')}}" method="POST">
    @csrf
    ...
    @endif
       <br>
    @include('report.error.table', $error)
  </div>
</div>
